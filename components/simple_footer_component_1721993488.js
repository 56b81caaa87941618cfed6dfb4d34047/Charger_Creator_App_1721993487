...
*/
Vue.component("simple_footer_component_1721993488", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            Bolt Up! Chargers App
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay connected with your Los Angeles Chargers. Get the latest news, scores, highlights, and behind-the-scenes access with our official app. Bolt up!
                    </div>
                </div>
            </div>
        </footer> 
